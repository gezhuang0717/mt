...
c      s2dX = val(42,naok) - s2eX
c      s2dY = val(44,naok) - s2eY
c      s2dZx = 500.
c      s2dZy = 500.
c      s2Zx =  1321.7 ! Distance from PPAC2 to s0-focal plane for X
c      s2Zy =  1313.1 ! Distance from PPAC2 to s0-focal plane for Y

c      val(46,naok) = atan(s2dX/s2dZx)*1000. ! angle for X @ ILC1
c      val(48,naok) = atan(s2dY/s2dZy)*1000. ! angle for Y @ ICL1
...
c     val(51,naok) = RF - 0.06751 * F5x ! RF cor by F5X
      ...
      val(52,naok) = val(22,naok) - 1.0000 * f6x ! F3dE(IC) cor by F6X
...
cccccccccccccccccc
      ...
      val(8,naok) = val(6,naok) - 700000. ! TOF ring offset -700usec
